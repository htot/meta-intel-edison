...
do_install:append() {
	...
	install -m 644 ${UNPACKDIR}/prepare-udevd.service ${D}/${systemd_unitdir}/system
	...
	install -Dm 0644 ${UNPACKDIR}/98-prepare-udevd.preset ${D}${systemd_unitdir}/system-preset/98-prepare-udevd.preset
}
